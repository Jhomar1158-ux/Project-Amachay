...
public class pantalla_diagnostico extends AppCompatActivity {
    public static String nombre = "Nicolás";          //Variable con el nombre del usuario obtenida al registrarse
    public static String color = "rojo";              //Variable con el diagnóstico obtenido de la interfaz Diagnósticos
    public static String malestar = "resfriado";      //Variable con el malestar, obtenido de la interfaz Diagnósticos(no terminado en esa interfaz)
    public static boolean dia = true;                //Variable dependiente del tiempo actual
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre = getString(R.string.valor_nombre);
...
/*
    ...
    public void diagnosticoFinal(){
                   //encabezado con el saludo al usuario
