...
import com.example.amachay.activities.Tienda.RegisterTiendaActivity;
...
//IMPORTAMOS APPCOMPAT ARRIBA
    ...
    private void gotoregister() {
        ...
        if(typeUser.equals("client"))
        {
            ...
            Intent intent = new Intent(SelectOptionAuthActivity.this, RegisterTiendaActivity.class);
            startActivity(intent);
        }
    }
}
