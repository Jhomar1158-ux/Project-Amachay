...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Button mButtonRequestDoctor;
...
// SI ES LA PRIMERA VEZ QUE ENTRA AQU
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonRequestDoctor = findViewById(R.id.btnRequestDoctor);
        ...
        onCameraMove();
        mButtonRequestDoctor.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void requestDoctor()
    {
        if(mOriginLatlng!=null && mDestinationLatlng!=null)
        {
            ...
            intent.putExtra("origin_lng",mDestinationLatlng.longitude);
        }
    ...
    private void getActiveDoctor()
    {
        ...
        mGeofireProvider.getActiveDoctor(mCurrentLatlng).addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
// AÑADIREMOS LOS MARCADORES DE LOS CONDUCTORES QUE SE CONECTEN EN LA APLICACION

                for (Marker marker: mDoctorsMarkers) {
