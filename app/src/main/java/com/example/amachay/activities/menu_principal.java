...
public class menu_principal extends AppCompatActivity {
    ...
    public void boton_perfil(){
        //typeuser  para saber que perfil abrir ... si tienda o cliente, dato del shared ("user") .... valores "client" && "tienda"
        final String type_user = mPref.getString("user","");
        if(type_user.equals("client")){
            Intent i = new Intent(menu_principal.this, perfil_cliente.class);
            startActivity(i);
        }
        else{
            Intent e = new Intent(menu_principal.this, activity_perfil_tienda.class);
            startActivity(e);
        }
