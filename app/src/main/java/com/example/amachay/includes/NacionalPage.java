...
public class NacionalPage extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nacional, container, false);
        ...
        mDatabaseReference = mFirebaseDatabase.getReference("NoticiasNacionales");// referencia en firebase
